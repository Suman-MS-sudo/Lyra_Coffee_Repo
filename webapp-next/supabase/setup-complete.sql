...
-- Updated by /api/machine/poll and /api/machine/heartbeat.
ALTER TABLE coffee_machines
...
VALUES
  ('admin@lyra.coffee', 'ad89b64d66caa8e30e5d5ce4a9763f4ecc205814c412175f3e2c50027471426d', 'Lyra Admin', true)
ON CONFLICT (email) DO NOTHING;

INSERT INTO coffee_customers (email, password_hash, name, company, is_active)
VALUES
  ('customer@lyra.coffee', 'dca3c4b909ce609ff9c33e704304bbda4bad5349098e4bfaa685323a1e8cdadf', 'Demo Customer', 'Lyra Demo Co.', true)
ON CONFLICT (email) DO NOTHING;
