...
export default async function MachinesPage() {
  const [machinesRes, customersRes] = await Promise.all([
    supabaseAdmin
      ...
      .select('id, name, location, status, api_key_hash, customer_id, is_free, price_coffee_paise, price_tea_paise, mac_id, mac_provisioned_at, last_seen_at, created_at, updated_at')
